...
db_multirow -extend { manage_roles delete } role_groups get_groups_list {} {
    ...
    set delete "<a href=\"[export_vars -base "imsld-delete-instance" { imsld_id run_id role group_id }]\" title=\"[_ imsld.Delete]\"><img src=\"/resources/acs-subsite/Delete16.gif\" width=\"16\" height=\"16\" border=\"0\" alt=\"[_ imsld.Delete]\"></a>"
